...
<div className={styles.parent_container}>
    ...
    <div className={styles.top_row}>
        <div className={styles.top_row_content}><BsTelephone /> <Text fontSize="13px" color="#666666">1860 123 1000</Text></div>
        <div className={styles.top_row_content}><TfiLocationPin /> <Text fontSize="13px" color="#4A4A4A">560004,Bangalore</Text> </div>
        <div className={styles.top_row_content}><FiUser /> <Text fontSize="13px" color="#4A4A4A">Login/Sign Up</Text></div>
    </div>
    {/* nav mid row */}
    <div className={styles.mid_row}>
      ...
      <div className={styles.mid_row_cart}>
        ...
        <div>
          <Text fontSize="13px" color="#4D4D4D">My Basket</Text>
          <Text fontSize="13px" color="#4D4D4D">0 Items</Text>
        </div>
      </div>
    </div>
    {/* nav bottom row */}
